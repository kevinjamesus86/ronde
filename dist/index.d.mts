 ...
 */
declare function formatToolResult(toolkit: Toolkit<any>, toolName: string, result: ToolResult, ctx?: FormatContext): Promise<string>;
...
type ProgressEvents = {
    ...
    tool_result: {
        turn: number;
        call: ToolCall; /** Formatted string the model sees — journaled as the ToolResultPart content. */
        content: string; /** Raw structured exec return. Never journaled. */
        result: ToolResult;
    };
};
...
interface RunObserver {
    ...
    onToolResult?(turn: number, toolCall: ToolCall, content: string, result: ToolResult): void;
